...
let ProjectsService = class ProjectsService {
    constructor(projectRepo, taskRepo, photoRepo, materialRepo) {
    ...
    async findOne(id, ownerId) {
        ...
        if (!project)
            throw new common_1.NotFoundException('פרויקט לא נמצא');
    ...
    async getTasks(projectId, ownerId) {
    ...
    async createTask(projectId, data, ownerId) {
        await this.findOne(projectId, ownerId);
    ...
    async generateReport(projectId, ownerId) {
